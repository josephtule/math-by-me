...
\begin{definition}
    ...
    \noindent are \textit{polynomial functions}\index{function!polynomial}. Where $n$ is the \textit{degree}\index{function!polynomial!degree} of the polynomial (whne $a_n \neq 0$) and $a_i$ for $i \in {0,1,\dots,n-1,n}$ are the coefficients.
\end{definition}
